...
export default function UsersCreate({ roles = [] }: RolesProps) {
            ...
            <Card>
                <form onSubmit={submit}>
                    <CardHeader>
                        ...
                        <CardDescription>{t('add.new.user')}</CardDescription>
                    </CardHeader>
                    ...
                    <CardFooter className="flex justify-end space-x-2">
                        ...
                        <Button type="submit" disabled={processing} className="bg-green-600 hover:bg-green-700">{t('save.user')}</Button>
                    </CardFooter>
                </form>
            </Card>
        </AppLayout>
